...
export function Workspace() {
    ...
    if (!club || !access)
        return (
            <div className="dx-public-content">
                ...
                >
                    <Link className="dx-button primary" to={club ? `/demo/clubs/${clubId}` : '/demo'}>
                        Tìm hiểu CLB <ArrowRight size={16} />
                    </Link>
                    <Link className="dx-text-link" to="/demo/my-clubs">
                        Về CLB của tôi
                    </Link>
                </Empty>
            </div>
    ...
    const base = `/demo/my-clubs/${clubId}`;
        ...
        <WorkspaceContext.Provider value={context}>
            <div className={`dx-workspace ${compact ? 'compact' : ''}`}>
                <aside className="dx-sidebar">
                    <Link className="dx-back" to="/demo/my-clubs">
                        <ArrowLeft size={15} />
                        CLB của tôi
                    </Link>
                    ...
                    <label className="dx-club-switch">
                        ...
                        <select
                            ...
                            value={clubId}
                            onChange={(e) => navigate(`/demo/my-clubs/${e.target.value}`)}
                        >
                            {state.memberships
