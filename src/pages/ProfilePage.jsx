    ...
    return (
        <div className="mx-auto max-w-5xl space-y-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                >
                    <div className="mx-auto flex h-28 w-28 items-center justify-center rounded-2xl bg-gradient-to-br from-yellow-500 via-orange-500 to-red-500 p-1">
                    ...
                    <div className="mt-5 flex items-center justify-center gap-2">
                        <span
                            className={`h-2.5 w-2.5 rounded-full ${user?.isActive && !user?.isLocked ? 'bg-emerald-400' : 'bg-rose-400'}`}
                        />
...
export default function ProfilePage() {
    ...
    return isSystemAdmin ? <SystemAdminProfile user={user} /> : <ExistingProfile />;
}
