...
import WorkspacePlaceholder from '../../components/v2/my-clubs/WorkspacePlaceholder';
=======
import { MyClubsPage, MySchedulePage } from './personal-pages/PersonalPages';
>>>>>>> Stashed changes
...
function AuthenticatedV2App() {
    ...
    return (
        <div className="v2-app">
            ...
            <LeftRail user={user} onLogout={logout} api={api} />
...
<<<<<<< Updated upstream
                    ...
                    <Route path="my-clubs/:clubId" element={<WorkspacePlaceholder />} />
=======
                    <Route path="my-clubs" element={<MyClubsPage api={api} sessionKey={sessionKey} clubAccess={clubAccess} />} />
