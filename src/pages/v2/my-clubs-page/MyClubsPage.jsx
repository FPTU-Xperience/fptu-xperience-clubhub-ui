...
import { useMyClubSelection, useMyMembershipApplications } from '../my-clubs-data';
...
export default function MyClubsPage({ api, sessionKey }) {
    ...
    const withdraw = async (applicationId) => {
        ...
        try { await api.withdrawMyMembershipApplication(applicationId); applications.retry(); selection.retry(); }
