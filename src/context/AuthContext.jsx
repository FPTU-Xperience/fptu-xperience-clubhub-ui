...
export function AuthProvider({ children }) {
    ...
    useEffect(() => {
        ...
        window.addEventListener('clubhub:unauthorized', handleUnauthorized);
        return () => window.removeEventListener('clubhub:unauthorized', handleUnauthorized);
    }, []);
